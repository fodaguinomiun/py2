...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
        ...
        print("tamanho da tela do computador",screen_width,screen_height,"tamanho da janela de resultados",width,height)
        print("posição do mouse", mouse.position,"posição central de linha das pontas",center_x,center_y)
